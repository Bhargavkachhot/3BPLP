...
@stack('after-styles')
    <style type="text/css">
      ...
      .box-shadow-z0 .box-color {
        box-shadow: 0 0px 1px rgb(255 255 255 / 42%);
      }
  ...
  <body>
    ...
    width: 45px;
    height: 38px;
    border-radius: 50%;" id="img_responsive_profile" title="{{ Auth::user()->name }}"> @else <img src="{{ asset('assets/dashboard/images/avatar.png') }}" style="vertical-align: middle;
    width: 45px;
    height: 38px;
    border-radius: 50%;" \> @endif <i class="on b-white bottom"></i>
                ...
                <div class="dropdown-menu pull-right dropdown-menu-scale"> @if (@Helper::GeneralWebmasterSettings('inbox_status')) @if (@Auth::user()->permissionsGroup->inbox_status) @endif @endif <a class="dropdown-item" href="{{ route('admin.profile', Auth::user()->id) }}">
                ...
                @else <div class="dropdown-menu pull-right dropdown-menu-scale">
        ...
        <div class="box main">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="470" height="300" viewBox="0 0 470 290">
            <defs>
          ...
          <a href="{{ route('admin') }}">
            <button type="button" class="btn btn-success" style="align-items: center;
  justify-content: center;">Return Back</button>
          </a>
        </div>
