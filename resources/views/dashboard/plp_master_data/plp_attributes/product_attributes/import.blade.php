...
@section('title','Import Product Attribute')
@section('content')
...
<div class="box">
   <div class="box-header dker">
      <h3><i class="fa fa-upload"  style="pointer-events: none;"></i> Import Product Attribute</h3>
      <small>
      <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
      <span>PLP Master Data</span> /
      <span>PLP Attributes</span> /
      <a href="{{ route('product.attributes') }}">Product Attributes</a> /
      <span>Import Product Attribute</span>  
      </small>
   </div>
   <div class="box-body">
      {{Form::open(['route'=>['product.attributes.import.store'],'method'=>'POST', 'files' => true])}}  
      <section id="tabs">
         <div class="container">
            <div class="row">
               <div class="col-xs-12 ">   
