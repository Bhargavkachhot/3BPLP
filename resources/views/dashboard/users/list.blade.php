...
<div class="padding">
   <div class="box">
      ...
      {{Form::open(['route'=>['user.bulk.action'],'method'=>'POST' ,'id'=>'bulk_action_form'])}}
      ...
      <a href="{{route('export.users')}}"   class="btn primary m-a pull-right"><i class="fa fa-download" aria-hidden="true"></i>
      Export</a>
      
      @if(isset($allowed_permissions) && $allowed_permissions->create == 1)

      <a href="{{route('user.create')}}"   class="btn primary m-a pull-right"><i class="fa fa-plus" aria-hidden="true"></i>
      Create User</a>
