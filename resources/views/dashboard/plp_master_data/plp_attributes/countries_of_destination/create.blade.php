...
@section('title','Create Countries Of Destination')
@section('content')
<?php
...
<div class="box">
   <div class="box-header dker">
      <h3><i class="material-icons">&#xe3c9;</i> Create Countries Of Destination</h3>
      <small>
      ...
      <span>Create Countries Of Destination</span>  
      </small>
   </div> 
   <div class="box-body">
      {{Form::open(['route'=>['countries.of.destination.store'],'method'=>'POST'])}}  
      <section id="tabs">
         <div class="container">
            <div class="row">
               <div class="col-xs-12 ">   
