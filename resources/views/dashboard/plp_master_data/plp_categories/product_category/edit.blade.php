...
<div class="padding edit-package edit-user">
   <div class="box">
      <div class="box-header dker">
         <h3><i class="material-icons">&#xe3c9;</i> Edit Product Category</h3>
         <small>
                  ...
                  <div class="col-xs-12 "> 
                     ...
                     <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="General">
                           {{Form::open(['route'=>['product.categories.update'],'method'=>'POST', 'files' => true])}} 
                                    ...
                                    <div class="card-body">
                                       <div class="row">
                                          <div class="col-sm-12" id="subcategory_selection">  
                                             <select class="selectpicker" name="subcategory_id" id="subcategory_id" data-live-search="true"> 
                                    ...
                                    <div class="card-body">
                                       <div class="row">
                                          ...
                                          <div class="col-sm-12">
                                             ...
                                             <input type="text" name="product_category" maxlength="255"  value="{{$category->product_category}}" class="form-control"> 
                                             <span class="help-block">
                                          ...
                                          <div class="col-sm-12">
                                             ...
                                             <input type="number" min="1" name="position" id="position" value="{{$category->position}}" class="form-control" onkeydown="javascript: return event.keyCode == 69 ? false : true">
                                             <span class="help-block">
