...
@section('title','View Countries Of Origin')
@section('content')
<?php
...
<div class="box">
   <div class="box-header dker">
      <h3><i class="btn btn-sm show-eyes list show-icon" style="pointer-events: none;"></i>  View Countries Of Origin</h3>
      <small>
      <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
      <span>PLP Master Data</span> /
      <span>PLP Attributes</span> /
      <a href="{{ route('countries.of.origin') }}">Countries Of Origin</a> /
      <span>View Countries Of Origin</span>  
      </small>
   </div> 
   <div class="box-body">
                        ...
                        <div class="col-sm-12">
                           <div class="row">
                              <div class="col-sm-6">
                                 ...
                                 <input type="text" name="country_short" value="{{$countries_of_origin->country_short}}" class="form-control" disabled>  
                              </div>
                              ...
                              <div class="col-sm-6">
                                 ...
                                 <input type="text" name="country" value="{{$countries_of_origin->country}}" class="form-control" disabled>  
                              </div>
                              <div class="col-sm-6">
                                 <label for="position"
                                    class="form-control-label">Position 
                                 </label> 
                                 <input type="number" name="position" value="{{$countries_of_origin->position}}" class="form-control" disabled> 
                              </div>
                              <div class="col-sm-6">
                              <label for="Status"
