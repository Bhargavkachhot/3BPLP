                  ...
                  <div class="col-xs-12 "> 
                     ...
                     <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="General">
                            {{Form::open(['route'=>['product.categories.store'],'method'=>'POST', 'files' => true,'id' => 'create_form'])}}   
                                    ...
                                    <div class="card-body">
                                       <div class="row">
                                          <div class="col-sm-12" id="primary_category_selection">  
                                             <select class="selectpicker" name="primary_category_id" id="primary_category_id" data-live-search="true" disabled title="Select primary category" >  
                                             </select>  
                                    ...
                                    <div class="card-body">
                                       <div class="row">
                                          <div class="col-sm-12" id="subcategory_selection">  
                                             <select class="selectpicker" name="subcategory_id" id="subcategory_id" data-live-search="true" title="Select subcategory"> 
                                    ...
                                    <div class="card-body">
                                       <div class="row">
                                          <div class="col-sm-12">
                                             ...
                                             <input type="text" name="artical_number" maxlength="255" class="form-control">
                                             <span class="help-block">
                                          ...
                                          <div class="col-sm-12">
                                             <label for="product_category"
                                                class="form-control-label">Product category <span class="valid_field">*</span> 
                                             </label> 
                                             <input type="text" name="product_category"  maxlength="255"    class="form-control"> 
                                             <span class="help-block">
                                          ...
                                          <div class="col-sm-12">
                                             ...
                                             <input type="text" name="url_key" id="url_key"  maxlength="255"  class="form-control">
                                             <span class="help-block">
                                          ...
                                          <div class="col-sm-12">
                                             ...
                                             <input type="text" name="full_url_key" id="full_url_key"   class="form-control" disabled>  
                                          </div>
                                          <div class="col-sm-12">
                                             <label for="position"
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="SEO">
                           {{Form::open(['route'=>['product.categories.store'],'method'=>'POST', 'files' => true,'id' => 'create_seo_form'])}}
...
$(document).on('change', "#subcategory_id", function () {  
   ...
   $.ajax({
        url: "{{route('product.categories.get.subcategory_url_key')}}",
        type: 'POST',
        data: {id: subcategory_id},
        error: function() {
          alert('Something is wrong, couldn\'t find url_key');
        },
        success: function(subcategory_url_key) {  
            var url_key = $('#url_key').val();
            if(url_key == ''){
               url_key = 'null';
            }
            function getPrimaryCategory(subcategory_id){
                        $.ajax({
                           type: "POST",
                           url: "{{route('product.get.primary.category')}}",
                           data: {id: subcategory_id},
                           async: false,
                           success: function(response){ 
                              ...
                              if(response.id == 0){
                                 ...
                                 $("#primary_category_id").html(data.html);   
                                 $("#primary_category_id").selectpicker('refresh'); 
                                 $('#primary_category_id').selectpicker('val', data.id); 
                              }   
                           }           
                        });
                     }
            getPrimaryCategory(subcategory_id);  
            var primary_category_id = $('#primary_category_id').val(); 
            var primary_category_url_key = null;
            if(primary_category_id != ''){   
                     function getData(primary_category_id){
                        $.ajax({
                           type: "POST",
                           url: "{{route('product.categories.get.primary_category_url_key')}}",
                           data: {id: primary_category_id},
                           async: false,
                           success: function(response){
                               primary_category_url_key = response;  

                           }           
                        });
                     }
                     getData(primary_category_id);      
            }else{
            ...
            $('#full_url_key').val(primary_category_url_key+'/'+subcategory_url_key+'/'+url_key);    
        } 
   }); 
}); 
   ...
   if(id != null){
         $.ajax({
              ...
              success: function(primary_category_url_key) {  
                  ...
                  var subcategory_url_key = null;
                  if(subcategory_id != ''){   
                           function getData(subcategory_id){
                              $.ajax({
                                 type: "POST",
                                 url: "{{route('product.categories.get.subcategory_url_key')}}",
                                 data: {id: subcategory_id},
