                        ...
                        <div class="col-sm-12">
                           <div class="row">
                              <div class="col-sm-6">
                                 ...
                                 <input type="text" name="product_attribute" value="{{old('product_attribute')}}" class="form-control"> 
