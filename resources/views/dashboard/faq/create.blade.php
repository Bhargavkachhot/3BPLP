...
<div class="padding edit-package edit-user">
   <div class="box">
      <div class="box-header dker">
         <h3><i class="fa fa-plus"></i> Create FAQ</h3>
         <small>
      ...
      <div class="box-body">
         {{Form::open(['route'=>['faq.store'],'method'=>'POST','id' => 'create_form'])}}  
         <section id="tabs">
            <div class="container">
               <div class="row">
                  <div class="col-xs-12 ">
                        ...
                        <div class="col-sm-12">
                           <div class="row">
                              <div> 
                                 ...
                                 <input type="number" name="position" value="{{old('position')}}" min="1"  class="form-control">
                              ...
                              <div> 
                                 ...
                                 <textarea class="form-control" id="page_content" name="answer" autofocus >{{old('answer')}}</textarea>
                                 <span class="help-block">
