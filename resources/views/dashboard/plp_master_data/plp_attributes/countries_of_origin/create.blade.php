...
@section('title','Create Countries Of Origin')
@section('content')
<?php
...
<div class="box">
   <div class="box-header dker">
      <h3><i class="material-icons">&#xe3c9;</i> Create Countries Of Origin</h3>
      <small>
      <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> / 
      <span>PLP Master Data</span> /
      <span>PLP Attributes</span> /
      <a href="{{ route('countries.of.origin') }}">Countries Of Origin</a> /
      <span>Create Countries Of Origin</span>  
      </small>
   </div> 
   <div class="box-body">
      {{Form::open(['route'=>['countries.of.origin.store'],'method'=>'POST'])}}  
      <section id="tabs">
         <div class="container">
            <div class="row">
               <div class="col-xs-12 ">   
                        ...
                        <div class="col-sm-12">
                           <div class="row">
                              <div class="col-sm-6">
                                 ...
                                 <input type="text" name="country_short" value="{{old('country_short')}}" class="form-control"> 
