...
@section('title','Edit Example Product')
@section('content')
...
<div class="padding edit-package edit-user">
   <div class="box">
      ...
      <div class="box-body">
         {{Form::open(['route'=>['example.products.update'],'method'=>'POST', 'files' => true])}}   
         <!-- Tabs -->
         <section id="tabs">
            <div class="container">
               <div class="row">
                              ...
                              <div class="col-sm-12">
                                 <div class="card">
                                    ...
                                    <div class="card-body">
                                       <div class="row">
                                          <div class="col-sm-12" >  
                                             <select class="selectpicker" name="product_category_id" id="product_category_id" data-live-search="true"> 
                                    ...
                                    <div class="card-body">
                                       <div class="row"> 
                                          <div class="col-sm-12">
                                             ...
                                             <input type="text" name="example_product" maxlength="255"  value="{{$example_product->example_product}}" class="form-control"> 
                                             <span class="help-block">
                                          ...
                                          <div class="col-sm-12">
                                             ...
                                             <input type="number" name="position"  min="1"  onkeydown="javascript: return event.keyCode == 69 ? false : true" value="{{$example_product->position}}" class="form-control">
                                             <span class="help-block">
