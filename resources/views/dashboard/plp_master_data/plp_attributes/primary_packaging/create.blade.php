...
@section('title','Create Primary Packaging')
@section('content')
<?php
...
<div class="box">
   <div class="box-header dker">
      <h3><i class="fa fa-plus"></i> Create Primary Packaging</h3>
      <small>
      <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> / 
      <span>PLP Master Data</span> /
      <span>PLP Attributes</span> /
      <a href="{{ route('primary.packaging') }}">Primary Packaging</a> /
      <span>Create Primary Packaging</span>  
      </small>
   </div> 
   <div class="box-body">
      {{Form::open(['route'=>['primary.packaging.store'],'method'=>'POST'])}}  
      <section id="tabs">
         <div class="container">
            <div class="row">
               <div class="col-xs-12 ">   
                        ...
                        <div class="col-sm-12">
                           <div class="row">
                              <div class="col-sm-6">
                                 ...
                                 <input type="text" name="primary_packaging" value="{{old('primary_packaging')}}" class="form-control"> 
