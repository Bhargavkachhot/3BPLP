...
@section('title','Import Countries Of Destination')
@section('content')
...
<div class="box">
   <div class="box-header dker">
      <h3><i class="fa fa-upload"></i> Import Countries Of Destination</h3>
      <small>
      ...
      <span>Import Countries Of Destination</span>  
      </small>
   </div> 
   <div class="box-body">
      {{Form::open(['route'=>['countries.of.destination.import.store'],'method'=>'POST', 'files' => true])}}  
      <section id="tabs">
         <div class="container">
            <div class="row">
               <div class="col-xs-12 ">   
                           ...
                           <div class="row">
                              <div class="col-sm-6">
                                 <label for="category_name"
                                    class="form-control-label">Countries Of Destination <span class="valid_field">*</span>
                                 </label> 
