                  ...
                  <div class="col-xs-12 "> 
                     ...
                     <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="General">
                           {{Form::open(['route'=>['primary.categories.store'],'method'=>'POST', 'files' => true,'id' => 'create_form'])}} 
                                    ...
                                    <div class="card-body">
                                       <div class="row">
                                          <div class="col-sm-12">
                                             ...
                                             <input type="text" name="category_name"  class="form-control limited_character" value="{{old('category_name')}}" maxlength="255" > 
                                          ...
                                          <div class="col-sm-12">
                                             ...
                                             <input type="text" name="url_key" maxlength="255"   class="form-control" id="url_key" value="{{old('url_key')}}">
                                             <span class="help-block">
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="SEO">
                           {{Form::open(['route'=>['primary.categories.store'],'method'=>'POST', 'files' => true,'id' => 'create_seo_form'])}} 
