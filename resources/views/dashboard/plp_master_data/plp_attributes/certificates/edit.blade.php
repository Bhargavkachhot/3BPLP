...
<div class="box">
   <div class="box-header dker">
      <h3><i class="material-icons">&#xe3c9;</i> Edit Certificate</h3>
      <small>
                        ...
                        <div class="col-sm-12">
                           <div class="row">
                              <div class="col-sm-6">
                                 ...
                                 <input type="text" name="certificate" value="{{$certificate->certificate}}" class="form-control"> 
                              ...
                              <div class="col-sm-6">
                                 ...
                                 <input type="number" name="position" value="{{$certificate->position}}" class="form-control">
                                 <span class="help-block">
                           ...
                           <div class="row">
                              <div class="col-sm-12">
                                 ...
                                 <textarea class="form-control" name="description" rows="3">{{$certificate->description}}</textarea>  
                              </div>  
                           </div> 
                           <div class="row"> 
                              <div class="col-sm-12">
