...
@section('title','Import Countries Of Origin')
@section('content')
...
<div class="box">
   <div class="box-header dker">
      <h3><i class="fa fa-upload"></i> Import Countries Of Origin</h3>
      <small>
      <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
      <span>PLP Master Data</span> /
      <span>PLP Attributes</span> /
      <a href="{{ route('countries.of.origin') }}">Countries Of Origin</a> /
      <span>Import Countries Of Origin</span>  
      </small>
   </div> 
   <div class="box-body">
      {{Form::open(['route'=>['countries.of.origin.import.store'],'method'=>'POST', 'files' => true])}}  
      <section id="tabs">
         <div class="container">
            <div class="row">
               <div class="col-xs-12 ">   
                           ...
                           <div class="row">
                              <div class="col-sm-6">
                                 <label for="category_name"
                                    class="form-control-label">Countries Of Origin <span class="valid_field">*</span>
                                 </label> 
                                 ...
                                 <span  style="color: red;" class='validate'>{{ $errors->first('file') }}</span>
                                 @endif
                                 </span> 
                              </div> 
                           </div>  
