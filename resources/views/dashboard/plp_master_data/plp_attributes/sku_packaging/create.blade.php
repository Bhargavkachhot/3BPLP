...
@section('title','Create SKU Packaging')
@section('content')
<?php
...
<div class="box">
   <div class="box-header dker">
      <h3><i class="fa fa-plus"></i> Create SKU Packaging</h3>
      <small>
      <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
      <span>PLP Master Data</span> /
      <span>PLP Attributes</span> /
      <a href="{{ route('sku.packaging') }}">SKU Packaging</a> /
      <span>Create SKU Packaging</span>  
      </small>
   </div> 
   <div class="box-body">
      {{Form::open(['route'=>['sku.packaging.store'],'method'=>'POST'])}}  
      <section id="tabs">
         <div class="container">
            <div class="row">
               <div class="col-xs-12 ">   
                        ...
                        <div class="col-sm-12">
                           <div class="row">
                              <div class="col-sm-6">
                                 ...
                                 <input type="text" name="sku_packaging" value="{{old('sku_packaging')}}" class="form-control"> 
