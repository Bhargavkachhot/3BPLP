...
<div class="padding edit-package edit-user">
   <div class="box">
      <div class="box-header dker">
         <h3><i class="btn btn-sm show-eyes list show-icon" style="pointer-events: none;"></i>  Show Subcategories</h3>
         <small>
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-sm-12">
                                             <label for="subcategory"
                                                class="form-control-label">Subcategory  
                                             </label> 
                                             <input type="text" name="subcategory" value="{{$category->subcategory}}" class="form-control" disabled> 
                                          </div>
                                          <div class="col-sm-12">
                                             <label for="url_key"
                                          ...
                                          <div class="col-sm-12">
                                             ...
                                             <input type="text" name="full_url_key" value="{{$category->full_url_key}}" class="form-control" disabled> 
                                          </div>
                                          <div class="col-sm-12">
                                             <label for="position"
