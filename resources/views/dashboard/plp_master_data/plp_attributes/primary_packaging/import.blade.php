...
@section('title','Import Primary Packaging')
@section('content')
...
<div class="box">
   <div class="box-header dker">
      <h3><i class="fa fa-upload"></i> Import Primary Packaging</h3>
      <small>
      <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> /
      <span>PLP Master Data</span> /
      <span>PLP Attributes</span> /
      <a href="{{ route('primary.packaging') }}">Primary Packaging</a> /
      <span>Import Primary Packaging</span>  
      </small>
   </div> 
   <div class="box-body">
      {{Form::open(['route'=>['primary.packaging.import.store'],'method'=>'POST', 'files' => true])}}  
      <section id="tabs">
         <div class="container">
            <div class="row">
               <div class="col-xs-12 ">   
